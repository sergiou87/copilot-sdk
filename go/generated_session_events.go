...
type Data struct {
	...
	ReasoningEffort                                                                              *PreviousReasoningEffort `json:"reasoningEffort,omitempty"`
	...
	PreviousReasoningEffort                                                                      *PreviousReasoningEffort `json:"previousReasoningEffort,omitempty"`
...
//
// Reasoning effort level after the model change, if applicable
type PreviousReasoningEffort string

const (
	High   PreviousReasoningEffort = "high"
	Low    PreviousReasoningEffort = "low"
	Medium PreviousReasoningEffort = "medium"
	Xhigh  PreviousReasoningEffort = "xhigh"
)
