...
from copilot.types import CopilotClientOptions, TelemetryConfig
...
class TestTelemetryConfig:
    ...
    def test_telemetry_config_in_client_options(self):
        """TelemetryConfig can be used in CopilotClientOptions."""
        ...
        assert options["telemetry"]["otlp_endpoint"] == "http://localhost:4318"
