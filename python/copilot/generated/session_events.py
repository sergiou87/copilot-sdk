...
class ContextClass:
    ...
    def from_dict(obj: Any) -> 'ContextClass':
        ...
        return ContextClass(cwd, base_commit, branch, git_root, head_commit, repository)
...
class PreviousReasoningEffort(Enum):
    """Reasoning effort level before the model change, if applicable
    
    Reasoning effort level used for model calls, if applicable
...
class Data:
    ...
    reasoning_effort: PreviousReasoningEffort | None = None
    """Reasoning effort level used for model calls, if applicable
    ...
    previous_reasoning_effort: PreviousReasoningEffort | None = None
    """Reasoning effort level before the model change, if applicable"""
    ...
    def from_dict(obj: Any) -> 'Data':
        ...
        reasoning_effort = from_union([PreviousReasoningEffort, from_none], obj.get("reasoningEffort"))
        ...
        previous_reasoning_effort = from_union([PreviousReasoningEffort, from_none], obj.get("previousReasoningEffort"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.reasoning_effort is not None:
            result["reasoningEffort"] = from_union([lambda x: to_enum(PreviousReasoningEffort, x), from_none], self.reasoning_effort)
        ...
        if self.previous_reasoning_effort is not None:
            result["previousReasoningEffort"] = from_union([lambda x: to_enum(PreviousReasoningEffort, x), from_none], self.previous_reasoning_effort)
